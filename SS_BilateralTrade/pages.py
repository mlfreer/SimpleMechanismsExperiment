...
class WelcomePage(Page):
	template_name ='SS_BilateralTrade/WelcomePage.html'
...
class PriceInputPage(Page):
	template_name ='SS_BilateralTrade/PriceInputPage.html'
	# always displayed
	def is_displayed(self):
		return True
...
class Results(Page):
    template_name ='SS_BilateralTrade/Results.html'


class BeliefsInputPage(Page):
	template_name ='SS_BilateralTrade/BeliefsInputPage.html'
	def is_displayed(self):
